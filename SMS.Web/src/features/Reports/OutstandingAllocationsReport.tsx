...
import { useLazyOutstandingAllocationsReportQuery } from "../../app/api";
import { DateRange } from "../../components/dateRange";
import { ReportComponentProps, ReportComponentRef } from "./utils";

export const OutstandingAllocationsReport = forwardRef<
  ReportComponentRef,
...
>(
  (
    ...
    const [getOutstandingAllocationsReport] =
    ...
    useImperativeHandle(
      ...
      () => ({
        submit: async () => {
          if (dateRange?.from && dateRange?.to) {
            onDownloadStart();
            const { error } = await getOutstandingAllocationsReport({
      ...
      [
        dateRange,
        getOutstandingAllocationsReport,
        onDownloadComplete,
        onDownloadStart,
        onError,
      ]
